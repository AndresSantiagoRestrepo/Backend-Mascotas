...
export class UsuarioController {
  ...
  async resetPassword(
    ...
    // notificar al usuario
    let contenido = `Hola, buen día. Hemos cambiado tu clave. Tus nuevas credenciales son: Usuario: ${usuario.nombre_usuario}  Clave: ${claveAleatoria}Tu equipo de Mascotas te espera. Feliz día.`;
